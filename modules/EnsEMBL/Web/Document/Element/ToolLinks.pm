...
## BEGIN LEPBASE MODIFICATIONS...
  ...
  push @links,   '<a href="'.$project_url.'" title="$project_url_title"><div class="lb-menu-category"><img title="'.$project_url_title.'" src="/i/cgp_favicon.png" class="lb-menu-linkicon"/>'.$project_url_title.'</div></a>';
